...
def get_args():
    ...
    parser.add_argument("--input_dir", default='test_results/raindrop/RainDrop', type=str)
    parser.add_argument("--gt_dir", default='D:/dataset/RainDrop/test/target', type=str)
