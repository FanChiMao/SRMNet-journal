...
from model_arch.SRMNet_WTFF import SRMNet_WTFF
...
parser.add_argument('--input_dir', default='D:/dataset/Denoise/DND', type=str,
                    help='Directory of validation images')
parser.add_argument('--result_dir', default='./test_results/DND', type=str,
                    help='Directory for results')
parser.add_argument('--weights', default='./checkpoints/denoising_realworld/models/model_bestPSNR.pth',
...
model_restoration = SRMNet_WTFF(in_chn=3, wf=64, depth=4)
