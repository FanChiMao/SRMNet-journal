...
parser.add_argument('--input_dir', default='D:/dataset/Denoise/SIDD/test', type=str, help='Directory of validation images')
parser.add_argument('--result_dir', default='./test_results/SIDD', type=str, help='Directory for results')
parser.add_argument('--weights', default='./checkpoints/denoising_realworld/break_models/model_bestPSNR.pth', type=str,
