...
parser.add_argument('--src_dir', default='D:/dataset/Denoise/SIDD-medium/SIDD_Medium_Srgb/Data', type=str, help='Directory for full resolution images')
parser.add_argument('--tar_dir', default='D:/dataset/Denoise/SIDD-medium/cropped',type=str, help='Directory for image patches')
